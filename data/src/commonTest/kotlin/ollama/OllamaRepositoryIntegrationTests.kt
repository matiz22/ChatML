...
class OllamaRepositoryIntegrationTests {
            ...
            val messages =
                listOf(
                    Message(
                        ...
                        content =
                            Content.Text(
                                "You are a helpful assistant who speaks like a pirate whenever you detect pirate-related words in the user's message. If the message contains words like \"arr\", \"matey\", \"sea\", \"ship\", \"captain\", \"treasure\", \"booty\", \"plunder\", \"parrot\", \"peg leg\", \"davy jones\", \"anchor\", \"scallywag\", \"buccaneer\", or \"kraken\" (case-insensitive), respond in full pirate speak, using nautical slang, old-timey expressions, and plenty o' \"yarrr\"s and \"aye aye\"s. Otherwise, respond normally.",
                            ),
                    ),
                    Message(
                        role = Role.USER,
    ...
    fun testGenericChatWithOllamaResponseUsingAddress() =
        runTest {
            ...
            // Given
            val model = "gemma3:4b" // Updated model name
            val messages =
                listOf(
                    Message(
                        role = Role.USER,
